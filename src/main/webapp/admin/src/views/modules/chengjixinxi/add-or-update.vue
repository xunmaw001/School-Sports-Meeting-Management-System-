    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="成绩编号" prop="chengjibianhao">
            <el-input v-model="ruleForm.chengjibianhao" 
                placeholder="成绩编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chengjibianhao" label="成绩编号" prop="chengjibianhao">
              <el-input v-model="ruleForm.chengjibianhao" 
                placeholder="成绩编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.baobiao" label="报表" prop="baobiao">
          <file-upload
          tip="点击上传报表"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.baobiao?ruleForm.baobiao:''"
          @change="baobiaoUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.baobiao" label="报表" prop="baobiao">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.baobiao.split(',')" :src="$base.url+item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="比赛成绩" prop="bisaichengji">
          <el-input v-model="ruleForm.bisaichengji" 
              placeholder="比赛成绩" clearable  :readonly="ro.bisaichengji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="比赛成绩" prop="bisaichengji">
              <el-input v-model="ruleForm.bisaichengji" 
                placeholder="比赛成绩" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../ssmrt393/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.baobiao!=null) {
		this.ruleForm.baobiao = this.ruleForm.baobiao.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    baobiaoUploadChange(fileUrls) {
	this.ruleForm.baobiao = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
