<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="撤销编号" prop="chexiaobianhao">
            <el-input v-model="ruleForm.chexiaobianhao" 
                placeholder="撤销编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chexiaobianhao" label="撤销编号" prop="chexiaobianhao">
              <el-input v-model="ruleForm.chexiaobianhao" 
                placeholder="撤销编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="撤销时间" prop="chexiaoshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.chexiaoshijian" 
                type="datetime"
                :readonly="ro.chexiaoshijian"
                placeholder="撤销时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chexiaoshijian" label="撤销时间" prop="chexiaoshijian">
              <el-input v-model="ruleForm.chexiaoshijian" 
                placeholder="撤销时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="撤销备注" prop="chexiaobeizhu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.chexiaobeizhu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.chexiaobeizhu" label="撤销备注" prop="chexiaobeizhu">
                    <span v-html="ruleForm.chexiaobeizhu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.chexiaoshijian = this.getCurDateTime()
  ...
  methods: {
	...
	this.ruleForm.chexiaobeizhu = this.ruleForm.chexiaobeizhu.replace(reg,'../../../ssmrt393/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `chexiaobaoming/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.chexiaobaomingCrossAddOrUpdateFlag = false;
						 this.parent.search();
